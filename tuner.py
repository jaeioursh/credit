...
test4=lambda x: test1(0,4,4,0,100,save=0,params=x)
test6=lambda x: test1(0,6,6,0,100,save=0,params=x)
test8=lambda x: test1(0,8,8,0,100,save=0,params=x)
...
def opt(test,num,idx):
    ...
    print(res.x)
    print(res.fun)
    with open("save/a"+str(num)+"-"+str(idx)+".pkl","wb") as f:
